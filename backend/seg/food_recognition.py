...
class FoodRecognition:
    def __init__(self, image_path):
        ...
        # Upload the image file once
        self.file = self.upload_to_gemini(image_path, mime_type="image/jpeg")
    ...
    def get_bounding_boxes(self, food_list):
        ...
        response = chat_session.send_message("run")
        bounding_boxes = response.text  # Assuming the response is in JSON format
